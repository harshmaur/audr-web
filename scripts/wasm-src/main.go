...
var cveByRule = map[string][]string{
	...
	"langfun-query-eval-injection":                        {"CVE-2026-75062"},
...
func formatHintToPath(hint string) string {
	...
	case "openaii", "openaii-pth", "openaii-pypi":
		return "/synth/venv/lib/python3.12/site-packages/openaii_loader.pth"
	...
	case "tronix-pypi-trongridi-key-exfil":
		return "/synth/venv/lib/python3.12/site-packages/trongridi/client.py"
	case "tronix-pypi-trongridew-key-exfil":
		return "/synth/venv/lib/python3.12/site-packages/trongridew/client.py"
	case "spaysrbdata-discordnv", "discordnv-pypi":
		return "/synth/venv/lib/python3.12/site-packages/discordnv/main.py"
	case "spaysrbdata-minecraftmodes", "minecraftmodes-pypi":
		return "/synth/venv/lib/python3.12/site-packages/minecraftmodes/main.py"
	case "pygame-renderkit", "pygame-renderkit-setup":
		return "/synth/pygame-renderkit-1.2.0/setup.py"
	case "pygame-renderkit-recon":
		return "/tmp/.rk_recon.py"
	case "pygame-renderkit-systemd":
		return "/synth/home/user/.config/systemd/user/renderkit.service"
	case "pygame-renderkit-sudoers":
		return "/synth/etc/sudoers.d/.renderkit"
	case "flask-header-guard-setup":
		return "/synth/flask-header-guard-1.0.0/setup.py"
	case "flask-header-guard-backdoor":
		return "/synth/venv/lib/python3.12/site-packages/flask_header_guard/backdoor.py"
	case "flask-header-guard-recon":
		return "/tmp/.fhg_recon.py"
	case "flask-header-guard-sudoers":
		return "/synth/etc/sudoers.d/.fhg"
	...
	case "amazon-inspector-dim-hydration-ui":
		return "/synth/node_modules/dim-hydration-ui/dist/index.mjs"
	case "amazon-inspector-dim-hydration-ui-binary":
		return "/synth/node_modules/dim-hydration-ui/dist/internal/math.bin"
